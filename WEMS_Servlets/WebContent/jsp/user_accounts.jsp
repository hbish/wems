    ...
    <script type="text/javascript">	
		...
		function deleteUser(userID)
		{
			$.modal({
				...
				'<form class="form with-margin" name="delete-user-form" id="delete-user-form" method="post" action="delete_user.jsp">'+
...
function OpenLogoutScriptlet() {
	window.location = "http://220.244.243.51:8080/WEMS_Servlets/Logout?user-name=<%=loginBean.getUserNameByIP(request.getRemoteAddr())%>";
		...
		<ul id="breadcrumb">
            ...
            <li><a href="#" title="List of Users">List of Users</a></li>
            <!-- InstanceEndEditable -->
		</ul>
        ...
        <section class="grid_12">
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
				...
				<table class="table sortable no-margin" cellspacing="0" width="100%">
					...
					<% 	
						List<UserDataClass> users = configBean2.getAllUsers();
						for (UserDataClass userData : users) {%>
						<tr>
							...
							<td class="table-actions">
								<a href="edit_user.jsp?user=<%=userData.getUserName() %>" title="Edit" class="with-tip"><img src="images/icons/fugue/pencil.png" width="16" height="16"></a>
								<a href="#" title="Delete" class="with-tip" onClick="deleteUser('123'); return false;"><img src="images/icons/fugue/cross-circle.png" width="16" height="16"></a>
							</td>
						</tr>
