  ...
  <div class="logo"><div class="container_12">	
    ...
    <nav id="main-nav">
        ...
        <ul class="container_12">
            ...
            <li class="users current"><a href="profile.jsp" title="Profile"
        ...
        <section class="grid_18">
			<div class="block-border"><div class="block-content">
				...
				<table class="table no-margin" cellspacing="0" width="100%">
					...
					<tbody>
						<%UserDataClass userData = configBean.getUserByUsername(userName);
						System.out.println("username: " + userName);
						System.out.println("first name: " + userData.getFirstName());//null
						%>
						<tr>
							<td>First Name</td>
                        ...
                        <tr>
							<td>Password</td>
							<td><a href="edit_profile.jsp#password">Change Password</a></td>
						</tr>
                        <tr>
							<td>Email</td>
                        ...
                        <tr>
							...
							<td><%=userData.getContactNumber()%></td>
						</tr>
                        <tr>
							<td>User Group</td>
							<td><%=userData.getUserGroup()%></td>
						</tr>
