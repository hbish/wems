...
function OpenLogoutScriptlet() {
	window.location = "http://220.244.243.51:8080/WEMS_Servlets/Logout?user-name=<%=loginBean.getUserNameByIP(request.getRemoteAddr())%>";
		...
		<ul id="breadcrumb">
            ...
            <li><a href="room.jsp?building=<%=building%>&level= <%=level%>&room=<%=room%>" title="Room XXX">Room <%=room%></a></li>
            <li><a href="#" title="Device">Device</a></li>
            <!-- InstanceEndEditable -->
		</ul>
...
<article class="container_12">
        ...
        <section class="grid_12">
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
				<h1>Device              
				<a href="new_alarm.jsp?building=<%=building%>&level=<%=level%>&room=<%=room%>&deviceuid=<%=deviceuid%>"><img src="images/icons/fugue/alarm-clock-blue.png" width="16" height="16"> Add Alarm</a>
				</h1>
                <div class="no-margin">
				<table class="table no-margin" cellspacing="0" width="100%">
					...
					<%Integer id = Integer.parseInt(deviceuid); %>
					<%SensordataDeviceDataClass deviceData = locBean.getDevice(id); %>
                        <tr>

							<td>Device ID</td>
							<td><%=deviceData.getId()%></td>
						</tr>
                        <tr>
							<td>Type</td>
							<td><%=deviceData.getType()%></td>
						</tr>
                        <tr>
							<td>Brand</td>
							 <td><%=deviceData.getBrand()%></td>
						</tr>
                        <tr>
							<td>Model</td>
							 <td><%=deviceData.getModel()%></td>
						</tr>
                        <tr>
							<td>Serial</td>
							<td><%=deviceData.getSerial()%></td>
						</tr>
                         <tr>
							<td>MAC Address</td>
							 <td><%=deviceData.getMacaddress()%></td>
						</tr>
                        <tr>
							<td>Connected</td>
							<td><%=deviceData.getConnected()%></td>
						</tr>
                        <tr>
							<td>Power</td>
							<td><%=deviceData.getPowerStatus()%></td>
						</tr>
                        <tr>
							<td>Parameters</td>
							<td><%=deviceData.getParameters()%></td>
						</tr>
