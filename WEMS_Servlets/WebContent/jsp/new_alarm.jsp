...
<article class="container_12">
        ...
        <section class="grid_12">
			<div class="block-border"><form class="block-content form" id="simple_form" method="post" action="http://220.244.243.51:8080/WEMS_Servlets/AddNewAlarm">
				<h1>New Alarm</h1>
				...
				<table class="table no-margin" cellspacing="0" width="100%">
					...
					<tbody>
					<%SensordataDeviceDataClass deviceData = locBean.getDevice(Integer.parseInt(deviceuid)); %>
                        <tr>

							<td>Building</td>
							<td><input type="text" name="building" id="building" value="<%=building%>" size="10"></td>
						</tr>
                        <tr>
							<td>Level</td>
							<td><input type="text" name="level" id="level"  value="<%=level%>" size="10"></td>
						</tr>
                        <tr>
							<td>Room</td>
							 <td><input type="text" name="room" id="room" value="<%=room%>" size="10"></td>
						</tr>
						<tr>
							<td>Device UID</td>
							<td><input type="text" name="deviceuid" id="deviceuid"  value="<%=deviceData.getDeviceuid()%>" size="10"></td>
						</tr>
                        <tr>
							<td>Device Type</td>
							 <td><input type="text" name="devicetype" id="devicetype" value="<%=deviceData.getType()%>" size="10"></td>
						</tr>
						<tr>
							<td>Device ID</td>
							 <td><input type="text" name="deviceid" id="deviceid" value="<%=deviceData.getId()%>" size="10"></td>
						</tr>
					</tbody>
				</table>
				<fieldset>
				<div>
                    <%List<String> plist = locBean.getPList(Integer.parseInt(deviceuid)); %>
