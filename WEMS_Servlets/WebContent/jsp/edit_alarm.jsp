			...
			<div class="block-border"><form class="block-content form" id="simple_form" method="post" action="http://220.244.243.51:8080/WEMS_Servlets/ModifyAlarm">
				...
				<table class="table no-margin" cellspacing="0" width="100%">
					...
					<%AlertSettingDataClass alarmData = alarmBean.getAlarmByID(Integer.parseInt(alarmid)); %>
							...
							<td>Alert ID</td>
							<td><input type="text" name="alertid" id="alertid" value="<%=alarmData.getAlertId()%>" size="10"></td>
						</tr>
                        <tr>
						...
						<tr>
							<td>Device UID</td>
							<td><input type="text" name="deviceuid" id="deviceuid"  value="<%=alarmData.getDeviceuid()%>" size="10"></td>
						</tr>
                        <tr>
							<td>Device Type</td>
				...
				<div>
                    ...
                    <label for="notification">Notification</label>
						<select name="notification" id="notification">
							...
							<%if(uglist.get(i).equals(alarmData.getUG())){ %>
                    ...
                    <label for="priority">Priority</label>
						<select name="priority" id="priority">
                            <option>- Select One -</option>
                            <%if(alarmData.getPriority().equals("Low")){ %>
                            	<option selected="yes" value="Low">Low</option>
                            <%}else{ %>
								<option value="Low">Low</option>
							<%}%>
							<%if(alarmData.getPriority().equals("Medium")){ %>
                            	<option selected="yes" value="Medium">Medium</option>
                            <%}else{ %>
								<option value="Medium">Medium</option>
							<%} %>
							<%if(alarmData.getPriority().equals("High")){ %>
                            	<option selected="yes" value="High">High</option>
                            <%}else{ %>
								<option value="High">High</option>
							<%} %>
							<%if(alarmData.getPriority().equals("Critical")){ %>
                            	<option selected="yes" value="Critical">Critical</option>
                            <%}else{ %>
