...
<meta http-equiv="Refresh" content="6,URL=http://220.244.243.51:8080/WEMS_Servlets/jsp/building.jsp?building=<%=building%>">
...
function OpenLogoutScriptlet() {
	window.location = "http://220.244.243.51:8080/WEMS_Servlets/Logout?user-name=<%=loginBean.getUserNameByIP(request.getRemoteAddr())%>";
		...
		<ul id="breadcrumb">
            ...
            <li><a href="#" title="Building">Building <%=building%></a></li>
            <!-- InstanceEndEditable -->
		</ul>
        ...
        <section class="grid_12">
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
				...
				<table class="table sortable no-margin" cellspacing="0" width="100%">
					...
					<tbody>
						<%List<String> levelNames = locBean.getLevels(building); %>
						<%for (int i =0; i<levelNames.size();i++){ %>
						<tr>
							<td><%=levelNames.get(i)%></td>
							<td><%=locBean.getLevelPowerUsage(building, levelNames.get(i))%></td>
							<td class="table-actions">
								<a href="level.jsp?building=<%=building%>&level=<%=levelNames.get(i)%>" title="View" class="with-tip"><img src="images/icons/fugue/magnifier.png" width="16" height="16"></a>
							</td>
						</tr>
                        <%}%>
