  ...
  <div class="logo"><div class="container_12">	
	...
	<nav id="main-nav">
		...
		<ul class="container_12">
			...
			<li class="estab"><a href="establishment.jsp" title="Establishment" onClick="document.location.href='overview.jsp'">Establishment</a>
			</li>
...
<article class="container_12">
		...
		<section class="grid_12">
			<div class="block-border">
				<h2>User Accounts</h2>
				<ul style="list-style: circle; margin-left: 20px; line-height: 2em;">
					<li><a href="user_accounts.jsp">List of Users</a></li>
					<li><a href="new_user.jsp">Add a new User</a></li>
				</ul>
				<h2>New Device</h2>
				<ul style="list-style: circle; margin-left: 20px; line-height: 2em;">
					<li><a href="devices.jsp">List of Devices</a></li>
				</ul>
				<h2>User Groups</h2>
				<ul style="list-style: circle; margin-left: 20px; line-height: 2em;">
					<li><a href="user_groups.jsp">View all User Groups</a></li>
				</ul>
			</div>
		</section>
